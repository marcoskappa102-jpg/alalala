...
private void CreateDefaultInventory(int characterId)
{
    ...
    // ✅ SIMPLIFICADO: Cria apenas o inventário vazio
    ...
    Console.WriteLine($"✅ Empty inventory created for character {characterId} with 100 gold");
    
    // ❌ REMOVIDO: Não cria mais as 5 poções iniciais
    // Os jogadores começam com inventário vazio + 100 gold
}
